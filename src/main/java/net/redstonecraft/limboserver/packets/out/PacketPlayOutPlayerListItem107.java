...
public class PacketPlayOutPlayerListItem107 implements PacketOut {

    private final UUID uuid;
    private final String name;

    public PacketPlayOutPlayerListItem107(UUID uuid, String name) {
        this.uuid = uuid;
        this.name = name;
    }
    ...
    public void write(PacketSerializer packetSerializer) throws IOException {
        ...
        packetSerializer.writeString("{\"text\":\"" + name + "\"}");
    }
